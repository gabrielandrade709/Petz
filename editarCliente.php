...
<html lang="en">
    ...
    <body>
            ...
            <div class="w3-bar w3-black w3-card">
                ...
                <div class="w3-dropdown-hover w3-hide-small">
                    ...
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        ...
                        <a href="excluirCliente.php"  class="w3-bar-item w3-button"><img src="resources/delete.png" alt="" style="padding-right: 10px;padding-bottom: 5px;" />Excluir</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w3-content" style="max-width:2000px;margin-top:46px">
            ...
            <div class="content" id="editarDados" style=" margin-left: 300px; width: 700px; ">
                <h2 style="margin-left: 250px; color: #0066cc; ">Editar</h2>            
