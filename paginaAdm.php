    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-black w3-card">
                ...
                <a href="paginaAdm.php" id="paginaInicial" class="w3-bar-item w3-button w3-padding-large" > <img src="resources/paginaInicial.png" alt="" style="padding-right: 10px;padding-bottom: 5px;" />Página inicial</a>
                ...
                <div class="w3-dropdown-hover w3-hide-small">
                    ...
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <a href="selecionarFuncionario.php" class="w3-bar-item w3-button"><img src="resources/funcionario.png" alt=""style="padding-right: 10px;padding-bottom: 5px;" />Funcionário</a>
                    </div>
                </div>
